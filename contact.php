  ...
  <body>
	...
	<?php
		...
		if(isset($_POST['submit'])){
			...
			echo "<script>alert('Thank you for contacting us, $name! We will get back to you soon.');</script>";
					...
					<div class="col-md-12">
						<div class="wrapper">
							<div class="row mb-5">
				        		...
				        		<div class="text">
					            <p><span>Website</span> <a href="http://localhost/PetConnect/">PetConnect.com</a></p>
					          </div>
				          </div>
								</div>
							</div>
